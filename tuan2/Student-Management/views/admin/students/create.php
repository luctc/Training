...
<form class="w-50 m-auto p-4 border rounded mt-4" action="index.php?act=students/store" method="post">
    <h2 class="text-center">Create Students</h2>
    <div class="row">
        <div class="col">
            <div class="mb-3">
                <label for="name" class="form-label">Name</label>
                <input type="text" class="form-control" id="name" name="name" placeholder="Nhập Name" value="<?= isset($name) ? $name : '' ?>">
        ...
        <div class="col">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="Email" name="email" placeholder="Nhập Email" value="<?= isset($email) ? $email : '' ?>">
    ...
    <div class="row">
        <div class="col">
            <div class="mb-3">
                ...
                <input type="tel" class="form-control" id="Phone" name="phone" placeholder="Nhập Phone" value="<?= isset($phone) ? $phone : '' ?>">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <input type="text" class="form-control" id="address" name="address" placeholder="Thanh Oai, Hà Nội" value="<?= isset($address) ? $address : '' ?>">
